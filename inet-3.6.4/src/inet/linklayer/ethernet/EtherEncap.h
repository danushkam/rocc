...
class INET_API EtherEncap : public cSimpleModule
{
  protected:
    ...
    long totalEcfSent; // total number of ECF frames sent
    long totalEcfNackSent; // total number of ECF NACK frames sent
    int interfaceId = -1;
  ...
  protected:
    ...
    virtual void handleSendECF(cMessage *msg);
    virtual void handleSendECFNack(cMessage *msg);
