...
void UDP::handleMessage(cMessage *msg)
{
    ...
    if (msg->arrivedOn("ipIn")) {
        ...
        else if (dynamic_cast<UDPReliableAppPacketAck*>(msg) != nullptr)
            send(msg, "appOut", ((UDPReliableAppPacketAck*)msg)->getAppGateIndex());
        else
...
void UDP::processPacketFromApp(cPacket *appData)
{
    ...
    appData->addPar("appGateIndex") = appData->getArrivalGate()->getIndex();
